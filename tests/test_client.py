...
from mtn_ussd_v1 import MtnUssdV1, AsyncMtnUssdV1, APIResponseValidationError
from mtn_ussd_v1._types import Omit
from mtn_ussd_v1._models import BaseModel, FinalRequestOptions
from mtn_ussd_v1._constants import RAW_RESPONSE_HEADER
from mtn_ussd_v1._exceptions import APIStatusError, APITimeoutError, APIResponseValidationError
from mtn_ussd_v1._base_client import (
    DEFAULT_TIMEOUT,
...
def _get_open_connections(client: MtnUssdV1 | AsyncMtnUssdV1) -> int:
...
class TestMtnUssdV1:
    client = MtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "mtn_ussd_v1/_legacy_response.py",
                        "mtn_ussd_v1/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "mtn_ussd_v1/_compat.py",
    ...
    def test_multipart_repeating_array(self, client: MtnUssdV1) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = MtnUssdV1(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_USSD_V1_BASE_URL="http://localhost:5000/from/env"):
            client = MtnUssdV1(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            MtnUssdV1(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            MtnUssdV1(
    ...
    def test_base_url_trailing_slash(self, client: MtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: MtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: MtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            MtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = MtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = MtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_omit_retry_count_header(
        self, client: MtnUssdV1, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncMtnUssdV1:
    client = AsyncMtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_multipart_repeating_array(self, async_client: AsyncMtnUssdV1) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(MTN_USSD_V1_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncMtnUssdV1(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncMtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncMtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncMtnUssdV1) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncMtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncMtnUssdV1(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncMtnUssdV1, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
